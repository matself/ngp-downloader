...
Vi har byggt ett QGIS-plugin ([NGP Downloader (Lantmäteriet)](https://github.com/matself/ngp-downloader)) mot Geodatakatalogens sök- och nedladdnings-API och testat samtliga publicerade datamängder med produktionsdata. Sammanfattningsvis fungerar plattformen tekniskt väl, men nyttan varierar mellan datamängderna.
